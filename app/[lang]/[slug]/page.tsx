...
import { getMdxBySlug, getMdxSlugs, getNextArticle } from '@/lib/mdx'
...
export default async function ArticlePage({
  ...
  const readLabel = lang === 'ar' ? `${mins} دق قراءة` : `${mins} min read`
  const metaText = `${frontmatter.date} · ${readLabel}`
